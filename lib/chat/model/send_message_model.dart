...
class SendChatModel {
  ...
  @override
  String toString() {
    return 'SendChatModel(userSenderId: $userSenderId, userSenderRegNo: $userSenderRegNo, userSenderNumber: $userSenderNumber, userSenderName: $userSenderName, userReceiverId: $userReceiverId, userReceiverRegNo: $userReceiverRegNo, userReceiverNumber: $userReceiverNumber, userReceiverName: $userReceiverName, textMasseg: $textMasseg)';
  }
}
