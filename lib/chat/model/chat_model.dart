...
class ChatModel {
  ...
  @override
  String toString() {
    return 'ChatModel(id: $id, senderId: $senderId, senderRegNo: $senderRegNo, senderNumber: $senderNumber, senderName: $senderName, receiverId: $receiverId, receiverRegNo: $receiverRegNo, receiverNumber: $receiverNumber, receiverName: $receiverName, textMasseg: $textMasseg, datetime: $datetime, massageStatus: $massageStatus)';
  }
}
