...
class JoinUserModel {
  ...
  @override
  String toString() {
    return 'JoinUserModel(userRegNo: $userRegNo, country: $country, userPhoneNumber: $userPhoneNumber, userImage: $userImage, userName: $userName, userBio: $userBio, userDob: $userDob, userIpAddress: $userIpAddress, userPhoneName: $userPhoneName)';
  }
}
